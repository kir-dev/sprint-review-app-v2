        ...
        <div className="flex items-center gap-2">
          {feature.assignee ? (
            <Avatar className="h-6 w-6">
              ...
              <AvatarFallback>
                {feature.assignee.fullName.substring(0, 2)}
              </AvatarFallback>
            </Avatar>
          ) : (
          ...
          <div className="flex gap-1">
            {feature.isBug && (
              <Badge
                variant="destructive"
                className="text-[10px] px-1 py-0 h-5 bg-red-600 hover:bg-red-700"
              >
                BUG
              </Badge>
            )}
            {feature.isFeature && (
              <Badge
                variant="default"
                className="text-[10px] px-1 py-0 h-5 bg-emerald-600 hover:bg-emerald-700"
              >
                FEATURE
              </Badge>
            )}
