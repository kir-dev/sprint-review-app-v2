...
export function UsersList({ users, isLoading, onPositionChange }: UsersListProps) {
              ...
              <div className="relative">
                <button
                  ...
                  className={cn(
                    ...
                    changingUserId === user.id && "opacity-50 cursor-not-allowed animate-pulse",
                    changingUserId !== user.id && "hover:shadow-md"
                  )}
                >
                  <span>{changingUserId === user.id ? "Frissítés..." : positionLabels[user.position]}</span>
